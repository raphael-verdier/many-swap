...
import './libraries/AdvancedMath.sol';

contract ManySwapPair is IERC20, ERC20  {
    ...
    constructor(address _token0, address _token1) ERC20("ManySwap pair", "MSWP") {
        token0 = _token0;
        token1 = _token1;
    }
    ...
    event Debbug(uint256 debugValue1, uint256 debugValue2);
